          ...
          @if (loading) {
            ...
            <div class="summary-bar app-service-bar">
              ...
              <div class="summary-item highlight-blue">
                ...
                <div class="summary-label">Total Due (2%)</div>
              </div>
              <div class="summary-item">
            ...
            <div class="pay-action-row">
              <p class="rate-note">App Service Fee = 2% of approved court reservation charges, paid to the Developer.</p>
                ...
                <table class="finance-table">
                  <thead>
                    <tr>
                      ...
                      <th class="col-amount">App Service (2%)</th>
                    </tr>
                  </thead>
                  <tbody>
                    @for (charge of reservationCharges; track charge._id) {
                      <tr>
                        ...
                        <td class="col-amount">{{ charge.amount | currency: 'PHP' : 'symbol' }}</td>
                        <td class="col-amount col-service">{{ charge.amount * 0.02 | currency: 'PHP' : 'symbol' : '1.2-2' }}</td>
                      </tr>
                    }
                  </tbody>
                  <tfoot>
